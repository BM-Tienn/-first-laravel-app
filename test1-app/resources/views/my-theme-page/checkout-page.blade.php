		...
		<div class="container">
			...
			<div class="checkout-left">	
				...
				<div class="checkout-right-basket">
					<x-nav-link :href="route('theme-single-page')" :active="request()->routeIs('theme-single-page')"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span>Continue Shopping</x-nav-link>
				</div>
